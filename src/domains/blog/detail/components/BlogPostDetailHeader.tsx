...
export function BlogPostDetailHeader({ post }: BlogPostDetailHeaderProps) {
  return (
    <MotionShell className="mb-8">
      <Link
        href="/blog"
        className="text-muted hover:text-foreground focus-visible:outline-focus inline-flex min-h-11 items-center text-sm transition-colors duration-180 focus-visible:outline-2 focus-visible:outline-offset-2 motion-reduce:transition-none"
      >
        글 목록
      </Link>
