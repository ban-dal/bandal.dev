...
- 신규 프로젝트 "카플랫"의 웹, 웹뷰 개발 환경 구축 및 디자인 시스템 컴포넌트를 적용한 제품 개발
- 다중 진행 버튼으로 구성된 Step Form을 단일 CTA + 시각 피드백 구조로 개선해 사용자 혼란 지점 제거
- 웹뷰 UX를 네이티브 앱 수준으로 개선
  - `framer-motion`, View Transition API로 앱 수준의 화면 전환 구현
  - Popover 기반 Select/Calendar를 Bottom Sheet로 전환해 모바일 인터랙션 패턴에 맞게 개선
  - 촬영 이미지 압축 스크립트 구현으로 10~30MB 사진을 1MB 이내로 최적화하며 품질 유지
