...
#### 카플랫 B2B 서비스 Web/Admin 초기 구축 및 운영 기반 구현

- Next.js App Router 기반 B2B 미들웨어 Web/Admin 개발 환경 초기 구성
- 차량 조회, 제어, 촬영 이미지 제출 등 운영 핵심 플로우 구현
- Kakao Map 클러스터링을 활용해 수천 대 규모 차량 마커 렌더링 부하 최적화
- AWS CloudWatch + RUM 기반 로그 수집 환경을 구성해 오류 추적 및 사용자 환경 모니터링 기반 구성
...
- OpenAPI YAML을 단일 소스로 사용해 TypeScript 타입과 Full Type Safe SDK 자동 생성 파이프라인 구성
